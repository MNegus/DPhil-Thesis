function [xs, hs] = outer_inner_jet_freesurface_composite(xMax, t, SubstrateFunctions)
...
%   SOLUTION, WHICH WILL BE DONE LATER.
    ...
    xsUpper = linspace(epsilon * d, xMax, 1e3);
    ...
    %% Inner-jet composite
    [xsLower, hsJet] = jetfreesurface(xMax, t, SubstrateFunctions);
    ...
    %% Combine solutions
    xs = [xsLower, xsUpper];
    hs = [hsCompositeJet, hsCompositeOuter];
